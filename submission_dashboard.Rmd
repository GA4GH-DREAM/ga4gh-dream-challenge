...
Submission data — cleaned and aggregated in the Synapse table `syn11713824` — was downloaded using the `synapseClient` package for R on `r lubridate::now("UTC")` UTC.  Some basic cleaning or merging of platform and environment names is also handled here for display purposes (note: participant-provided documentation as seen on [**Submission Tracker boards**](https://www.synapse.org/#!Synapse:syn8507133/wiki/451414) and the README for each submission has not been changed).
